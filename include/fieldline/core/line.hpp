...
/*! Class representing a line in the poloidal plain
*/
...
namespace Fieldline {
    namespace core {
        class line {
            ...
            protected:
                /*! R value of the first point. */
                double m_R0;
                /*! z value of the first point. */
                double m_z0;
                /*! R value of the second point. */
                double m_R1;
                /*! z value of the second point. */
                double m_z1;
                /*! Distance between the two points in R: \f$ R_1 - R_0 \f$ */
                double m_dR;
                /*! Distance between the two points in z: \f$ z_1 - z_0 \f$ */
                double m_dz;
        };
    }
}
