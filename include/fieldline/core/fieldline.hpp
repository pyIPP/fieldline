...
namespace Fieldline {
    namespace core {
        /*! \brief Class containing the field line information.
         *
        ...
        class fieldline {
            public:
                ...
                /*! \brief Constructor
                 *
                 * This constructor initializes the field line with the given coordinates \f$(R,z,\phi)\f$ and the total magnetic field.
                */
                ...
                /*! \brief Append point at the end of the field line
                 *
                ...
                /*! \brief Return the x coordinates of the field line.
                 *
                ...
                /*! \brief Return the y coordinates of the field line.
                 *
                ...
                /*! \brief Return the z coordinates of the field line 
                 *
                ...
                /*! \brief Return the R coordinates of the field line 
                 *
                ...
                /*! \brief Return the toroidal angle of the field line
                 *
                ...
                /*! \brief Return the total magnetic field of the field line
                 *
...
#ifdef WITH_PYTHON
                /*! \brief Return the x coordinates of the field line as python list.
                 *
                 *  This function returns the x coordinates of the field line: \f$ x = R \cos(\phi)\f$
                ...
                /*! \brief Return the y coordinates of the field line as python list.
                 *
                 *  This function returns the y coordinates of the field line: \f$ y = R \sin(\phi)\f$
                 *  This function is intended as a python interface, never use this function from within python.
                 */
                ...
                /*! \brief Return the R coordinates of the field line as python list.
                 *
                 *  This function returns the R coordinates of the field line.
                 *  This function is intended as a python interface, never use this function from within python.
                 */
                ...
                /*! \brief Return the toroidal angle of the field line as python list.
                 *
                 *  This function returns the toroidal angle \f$\phi\f$ of the field line.
                 *  This function is intended as a python interface, never use this function from within python.
                 */
                ...
                /*! \brief Return the total magnetic field of the field line as python list
                 *
                 *  This function returns the total magnetic field \f$B_{tot}\f$ of the field line.
                 *  This function is intended as a python interface, never use this function from within python.
                 */
                ...
                /*! \brief Last R value in field line.
                 *
                ...
                /*! \brief Last z value in field line.
                 *
                ...
                /*! \brief Write field line to file.
                 *
                ...
                /*! \brief Read field line from file.
                 *
                ...
                /*! \brief Return the last line segment of the field line.
                 *
                ...
                /*! \brief Replace the end of the field line
                 *
            ...
            protected:
                ...
                std::vector<double> m_z; /*!< \brief z coordinates of the field line */
                std::vector<double> m_phi; /*!< \brief Toroidal angle \f$\phi\f$ of the field line */
                std::vector<double> m_Btot; /*!< \brief Total magnetic field of the field line */
        };
    }
}
